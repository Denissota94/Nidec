...
function timeline_um_body_flat($post_id)
	...
	//echo"<pre>".print_r($post_slug, true)."</pre>"; 
	if ($post_slug == '2015-4' || $post_slug == '2012') 
			$style = ' timeline-green timeline-term-'.$categories[0]->term_id;	
		elseif ($post_slug == '1953' || $post_slug == '1960') 
				$style = ' timeline-lightblue timeline-term-'.$categories[0]->term_id;
			elseif ($post_slug == '2012-2' || $post_slug == '2006' || $post_slug == '2005' || $post_slug == '2000' || $post_slug == '1989-1995' || $post_slug == '1950' || $post_slug == '1899' || $post_slug == '1853') 
				$style = ' timeline-blue timeline-term-'.$categories[0]->term_id;
		//$categories = wp_get_post_terms(get_the_ID(), 'testimonial_entries');
		//$style = empty($categories) ? '' : ' timeline-lightblue timeline-term-'.$categories[0]->term_id;
		
		$timeline_um_body.= '<li oddeven="'.$even_odd.'" class="timeline_um-item '.$even_odd.$style.'" >';
